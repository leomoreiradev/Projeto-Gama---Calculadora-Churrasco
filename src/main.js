...
const calcularChurrasco = () => {
    ...
    document.getElementById("total-carne").innerHTML = `Total carne:${getValueMeasure(totalCarne, 1)}`
    document.getElementById("total-pessoas").innerHTML = `Total pessoas:${totalPessoas} pessoas`
    document.getElementById("total-acompanhamento").innerHTML = `Total acompanhamento:${getValueMeasure(totalAcompanhamento, 1)}`
    document.getElementById("total-bebidas-nao-alcoolicas").innerHTML = `Totao de bebida não alcoolica:${getValueMeasure(totalBebidasNaoAlcoolicas, 2)}`
    document.getElementById("total-bebidas-alcoolicas").innerHTML = `Total bebida alcoolica:${getValueMeasure(totalBebidasAlcoolicas, 2)}`
